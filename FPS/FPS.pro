...
FPSRootPath=/home/brian/Documents/Programming/games/first_person_shooter/FPS

gameProjectFile=/home/brian/Documents/Programming/games/first_person_shooter/FPS/FPS.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(FPSSource.pri)
include(FPSHeader.pri)
include(FPSConfig.pri)
include(FPSIncludes.pri)
include(FPSDefines.pri)
...
FPS-Linux-Debug.commands = $$build FPS Linux Debug  -project="\"$$gameProjectFile\"" $$args
FPS-Linux-DebugGame.commands = $$build FPS Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FPS-Linux-Shipping.commands = $$build FPS Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FPS-Linux-Test.commands = $$build FPS Linux Test  -project="\"$$gameProjectFile\"" $$args
FPS.commands = $$build FPS Linux Development  -project="\"$$gameProjectFile\"" $$args

FPSEditor-Linux-Debug.commands = $$build FPSEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
FPSEditor-Linux-DebugGame.commands = $$build FPSEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FPSEditor-Linux-Shipping.commands = $$build FPSEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FPSEditor-Linux-Test.commands = $$build FPSEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
FPSEditor.commands = $$build FPSEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
